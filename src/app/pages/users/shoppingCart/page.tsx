        ...
        <BasicCard>
          ...
          <div className="flex flex-wrap space-x-72" >
            <div className="flex flex-grow-1 flex-col">            
              <button className="bg-white text-black pb-5">+ Agregar producto</button>
              <button className="bg-red-200 rounded-3xl text-black w-52">Ver mis pedidos</button>
            </div>
            <div className="flex flex-grow-1 flex-col">
              <p className="bg-white text-black text-center pb-5">Subtotal: 128</p>
              <button className="bg-red-200 rounded-3xl text-black w-52">Finalizar compra</button>
            </div>
          </div>
        </BasicCard>
      </div>
